...
HD_PWD='C:/Users/james/source/repos/E_E-324/project_01-1/project_01-1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log count_wrap.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source count_wrap.tcl -notrace
