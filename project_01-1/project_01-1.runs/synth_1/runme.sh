...
HD_PWD='C:/Users/james/source/repos/E_E-324/project_01-1/project_01-1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log count_wrap.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source count_wrap.tcl
